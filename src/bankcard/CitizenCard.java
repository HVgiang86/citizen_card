...
public class CitizenCard extends Applet implements ExtendedLength {
	...
	private static final byte[] PIN_DEFAULT = new byte[] { (byte) '1', (byte) '2', (byte) '3', (byte) '4', (byte) '5',
			(byte) '6' };
	...
	public CitizenCard() {
		...
		signatureBuf = JCSystem.makeTransientByteArray((short) (KeyBuilder.LENGTH_RSA_1024 / 8),
	...
	private void getInformation(APDU apdu) {
		...
		informationDataLength = aes.decode(personalInformation, (short) 0, (short) informationDataLength, key, buffer,
				(short) 0);
